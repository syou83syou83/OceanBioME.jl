...
set!(model, P=Pᵢ, Z=Zᵢ, sPON=sPONᵢ, bPON=bPONᵢ, sPOC=sPOCᵢ, bPOC=bPOCᵢ, NO₃=NO₃ᵢ, NH₄=NH₄ᵢ, DON=DONᵢ, SRDON=SRDONᵢ, RDON=RDONᵢ, DOC=DOCᵢ, SRDOC=SRDOCᵢ, RDOC=RDOCᵢ, DIC=DICᵢ, Alk=Alkᵢ, O₂=O₂ᵢ)  #没有速度了
...
scale_negative_tracers = ScaleNegativeTracers((:NO₃, :NH₄, :P, :Z, :sPOM, :bPOM, :DOM, :SRDOM, :RDOM))   #ScaleNegativeTracers(;model, tracers = (:NO₃, :NH₄, :P, :Z, :sPOM, :bPOM, :DOM)) changed (:NO₃, :NH₄, :P, :Z, :sPON, :bPON, :DON)
